...
public class GameLoop extends JFrame {
	...
	final public static int SCREEN_HEIGHT = 730;
	final public static int SCREEN_WIDTH = 760;
	final public static int BARRIER_WIDTH = 20;
...
//    	Rectangle top = new Rectangle(0, 0, SCREEN_WIDTH, BARRIER_WIDTH);
//    	barriers.add(top);
//    	Rectangle bottom = new Rectangle(0, SCREEN_HEIGHT - BARRIER_WIDTH, SCREEN_WIDTH, BARRIER_WIDTH);
//    	barriers.add(bottom);
//    	Rectangle left = new Rectangle(0, 0, BARRIER_WIDTH, SCREEN_HEIGHT);
//    	barriers.add(left);
//    	Rectangle right = new Rectangle(SCREEN_WIDTH - BARRIER_WIDTH,0, BARRIER_WIDTH, SCREEN_WIDTH);
//    	barriers.add(right);
    }
    
    private void createSprites() {
   		
    	me = new SimpleSprite(SCREEN_WIDTH / 2 , SCREEN_HEIGHT / 2);
    	sprites.add(me);
//    	BouncingSprite bouncy = new BouncingSprite(SCREEN_WIDTH / 2, 100);
//    	sprites.add(bouncy);
